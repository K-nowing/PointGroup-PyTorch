...
class S3DISCustomBatch:
    ...
    def __init__(self, input_list):
        ...
        ind += 1
        self.semantic_labels = torch.from_numpy(input_list[ind])
        ind += 1
        self.instance_labels = torch.from_numpy(input_list[ind])
        ind += 1
        self.instance_centers = torch.from_numpy(input_list[ind])
        ind += 1
        self.cloud_slices = torch.from_numpy(input_list[ind])
        ind += 1
        ...
        ## make offsets ground truth    
        self.gt_offsets = self.instance_centers - self.points[0]
    ...
    def pin_memory(self):
        ...
        self.semantic_labels = self.semantic_labels.pin_memory()
        self.instance_labels = self.instance_labels.pin_memory()
    ...
    def to(self, device):
        ...
        self.instance_labels = self.instance_labels.to(device)
        ...
        self.gt_offsets = self.gt_offsets.to(device)
