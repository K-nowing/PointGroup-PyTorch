...
from models.model import PointGroup
...
if __name__ == '__main__':
    ...
    # previous_training_path = 'beforeChangeOffset20_004'
    ...
    t1 = time.time()
    net = PointGroup(config, training_dataset.label_values, training_dataset.ignored_labels)
